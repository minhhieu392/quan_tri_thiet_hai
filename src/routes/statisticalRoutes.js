...
router.get(
  '/nhucau/tonghopnhucau',
  statisticalServicesValidate.getRequestsFilter,
  statisticalController.get_request_sum
);

router.get(
  '/nhucau/hotrokhacphuc',
  statisticalServicesValidate.getRequestsFilter,
  statisticalController.get_response_sum
);

router.get(
  '/nhucau/tonghopnhucaukhacphuc',
  statisticalServicesValidate.getRequestsFilter,
  statisticalController.get_request_detail
);

router.get(
  '/nhucau/tonghopnguonhotro',
  statisticalServicesValidate.getRequestsFilter,
  statisticalController.get_responses_detail
);
