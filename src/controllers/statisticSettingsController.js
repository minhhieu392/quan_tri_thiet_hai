...
import statisticSettingsService from '../services/statisticSettingsService';
...
export default {
  ...
  get_targets_tree: (req, res, next) => {
    ...
    try {
      const { id } = req.params;
      const { sort, range, filter } = req.body;
      const param = {
        sort,
        range,
        filter,
