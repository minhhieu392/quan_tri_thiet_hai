...
export default {
  ...
  create: (req, res, next) => {
    ...
    try {
      ...
      adsService.create(param).then(data => {
  ...
  update: (req, res, next) => {
    ...
    try {
      ...
      adsService.update(param).then(data => {
        if (data && data.result) {
          const dataOutput = {
            result: data.result,
            success: true,
  ...
  delete: (req, res, next) => {
    ...
    try {
      ...
      adsService.delete(param).then(data => {
  ...
  update_status: (req, res, next) => {
    ...
    try {
      ...
      adsService.update_status(param).then(data => {
        if (data && data.result) {
          const dataOutput = {
            result: data.result,
            success: true,
  ...
  updateOrder: (req, res, next) => {
    ...
    try {
      ...
      adsService.updateOrder(param).then(data => {
        if (data && data.result) {
          const dataOutput = {
            result: data.result,
            success: true,
