import groupSiteService from '../services/groupSiteService'
...
export default {
  get_list: (req, res, next) => {
    ...
    try {
      ...
      groupSiteService.get_list(param).then(data => {
        const dataOutput = {
          result: {
            list: data.rows,
            pagination: {
  ...
  get_one: (req, res, next) => {
    ...
    try {
      ...
      // console.log("groupSiteService param: ", param)
      groupSiteService.get_one(param).then(data => {
        res.send(data);
  ...
  create: (req, res, next) => {
    ...
    try {
      ...
      groupSiteService.create(param).then(data => {
  ...
  update: (req, res, next) => {
    ...
    try {
      ...
      groupSiteService.update(param).then(data => {
        if (data && data.result) {
          const dataOutput = {
            result: data.result,
            success: true,
  ...
  update_status: (req, res, next) => {
    ...
    try {
      ...
      groupSiteService.update_status(param).then(data => {
        if (data && data.result) {
          const dataOutput = {
            result: data.result,
            success: true,
