import siteProfileService from '../services/siteProfileService'
...
export default {
  get_list: (req, res, next) => {
    ...
    try {
      ...
      siteProfileService.get_list(param).then(data => {
        const dataOutput = {
          result: {
            list: data.rows,
            pagination: {
  ...
  get_one: (req, res, next) => {
    ...
    try {
      ...
      // console.log("siteProfileService param: ", param)
      siteProfileService.get_one(param).then(data => {
        res.send(data);
  ...
  create: (req, res, next) => {
    ...
    try {
      ...
      siteProfileService.create(param).then(data => {
  ...
  update: (req, res, next) => {
    ...
    try {
      ...
      siteProfileService.update(param).then(data => {
        if (data && data.result) {
          const dataOutput = {
            result: data.result,
            success: true,
  ...
  delete: (req, res, next) => {
    ...
    try {
      ...
      siteProfileService.delete(param).then(data => {
