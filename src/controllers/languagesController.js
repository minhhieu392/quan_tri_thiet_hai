...
export default {
  get_list: (req, res, next) => {
    ...
    try {
      ...
      languagesService.get_list(param).then(data => {
        const dataOutput = {
          result: {
            list: data.rows,
            pagination: {
  ...
  get_one: (req, res, next) => {
    ...
    try {
      ...
      // console.log("languagesService param: ", param)
      languagesService.get_one(param).then(data => {
        res.send(data);
  ...
  create: (req, res, next) => {
    ...
    try {
      ...
      languagesService.create(param).then(data => {
  ...
  update: (req, res, next) => {
    ...
    try {
      ...
      languagesService.update(param).then(data => {
        if (data && data.result) {
          const dataOutput = {
            result: data.result,
            success: true,
  ...
  delete: (req, res, next) => {
    ...
    try {
      ...
      languagesService.delete(param).then(data => {
  ...
  get_all: (req, res, next) => {
    try {
      ...
      try {
        ...
        languagesService.get_all(param).then(data => {
          res.send({
            result: data,
            success: true,
            errors: null,
