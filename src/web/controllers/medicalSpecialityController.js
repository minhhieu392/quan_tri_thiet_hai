import medicalSpecialityService from '../services/medicalSpecialityService';
...
export default {
    ...
    try {
      ...
      medicalSpecialityService
        ...
        .then(data => {
          ...
          res.header('Content-Range', `medicalSpecialities ${range}/${data.count}`);
          res.send(dataOutput);
          // write log
  ...
  get_one: (req, res, next) => {
    ...
    try {
      ...
      // console.log("medMedicineLocationService param: ", param)
      medicalSpecialityService
        .get_one(param)
        .then(data => {
          res.send(data);
