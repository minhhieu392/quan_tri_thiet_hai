...
export default {
  get_list: (req, res, next) => {
    ...
    try {
      ...
      socialChannelService.get_list(param).then(data => {
        const dataOutput = {
          result: {
            list: data.rows,
            pagination: {
        ...
        res.header('Content-Range', `socialChannels ${range}/${data.count}`);
        res.send(dataOutput);
        // write log
  ...
  get_one: (req, res, next) => {
    ...
    try {
      ...
      // console.log("paymentMethodService param: ", param)
      socialChannelService.get_one(param).then(data => {
        res.send(data);
  ...
  create: (req, res, next) => {
    ...
    try {
      ...
      socialChannelService.create(param).then(data => {
  ...
  update: (req, res, next) => {
    ...
    try {
      ...
      socialChannelService.update(param).then(data => {
        if (data && data.result) {
          const dataOutput = {
            result: data.result,
            success: true,
  ...
  delete: (req, res, next) => {
    ...
    try {
      ...
      socialChannelService.delete(param).then(data => {
  ...
  get_all: (req, res, next) => {
    try {
      ...
      try {
        ...
        socialChannelService.get_all(param).then(data => {
          res.send({
            result: data,
            success: true,
            errors: null,
