import productsCatalogService from '../services/productsCatalogService';
...
export default {
    ...
    try {
      ...
      productsCatalogService
        ...
        .then(data => {
          ...
          res.header('Content-Range', `productsCatalogs ${range}/${data.count}`);
          res.send(dataOutput);
          // write log
  ...
  get_one: (req, res, next) => {
    ...
    try {
      ...
      // console.log("productsCatalogService param: ", param)
      productsCatalogService
        .get_one(param)
        .then(data => {
          res.send(data);
  ...
  //         productsCatalogService.delete(param).then(data => {
  ...
  //     }
  // },
  get_all_site: (req, res, next) => {
    try {
      recordStartTime.call(req);
      const { sort, attributes, filter, range, limitPerCatalog } = res.locals;
