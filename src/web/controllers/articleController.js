...
export default {
  get_list: (req, res, next) => {
    ...
    try {
      ...
      articleService.get_list(param).then(data => {
        const dataOutput = {
          result: {
            list: data.rows,
            pagination: {
  ...
  get_one: (req, res, next) => {
    ...
    try {
      ...
      console.log("articleService param: ", param)
      articleService.get_one(param).then(data => {
        res.send(data);
  ...
  get_all: (req, res, next) => {
    try {
      ...
      try {
        ...
        console.log("articleService get_all PARAM: ", param)
        // param = {
        ...
        articleService.get_all(param).then(data => {
          res.send({
            result: data,
            success: true,
            errors: null,
